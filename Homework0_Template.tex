...
% Please leave the pagebreak
\pagebreak
\paragraph{Q3.1:} Here is an image: \href{grizzlypeakg.png}{grizzlypeakg.png} (in images folder)
...
\emph{Image:} \href{grizzlypeak.jpg}{grizzlypeak.jpg} (also in images folder) is a color version of the same image.
...
\emph{Image:} \href{gigi.jpg}{gigi.jpg} (in images folder)
