...
\begin{itemize}
  \item 7 questions \textbf{[4 + 4 + 8 + 6 + 6 + 3 + 3 = 34 points]}.
...
% Please leave the pagebreak
\pagebreak
    \paragraph{Q5:} \textbf{[6 points]} Your friend tries to write code that reads in an image and displays it. 
...
\item \textbf{[1 point]} Your friend comes to you and wants help darkening an image.
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black]
Using your answer from part (b) (ii), read in 'gigi.jpg', darken the pixel intensities by 20\% of the \emph{initial total brightness range of the data type}, and display the new image. Include your code and a screenshot of the darkened image.
\end{tcolorbox}
