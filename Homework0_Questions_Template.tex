...
\end{python}
    ...
    TODO: Your answer for (b) (i) here %%%%%% Remove this line in your answer! %%%%%%
...
\begin{tcolorbox}[colback=white!5!white,colframe=green!75!black]
    ...
    TODO: Your answer for (b) (iii) here %%%%%% Remove this line in your answer! %%%%%%
...
\begin{tcolorbox}[colback=white!5!white,colframe=green!75!black,height=8cm,height fill]
    ...
    \begin{python}
    # TODO: paste your code here %%%%%% Remove this line in your answer! %%%%%%
    \end{python}
\end{tcolorbox}
